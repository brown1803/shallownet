...
H = model.fit(trainX, trainY, validation_split = 0.1, batch_size=32, epochs=100, verbose=1)
...
plt.plot(np.arange(0, 100), H.history["val_loss"], label="Mất mát validation")
plt.plot(np.arange(0, 100), H.history["accuracy"], label="Độ chính xác khi trainning")
plt.plot(np.arange(0, 100), H.history["val_accuracy"], label="Độ chính xác validation ")
